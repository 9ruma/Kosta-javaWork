...
public class ElectronicsServiceImpl implements ElectronicsService {
    ...
    private ElectronicsServiceImpl() {
    	...
    	File file = new File("src/electronics.txt");
    	...
    	if(file.exists()) {
    		try(ObjectInputStream ois = new ObjectInputStream(new FileInputStream(file))) {
    			...
    			list = new ArrayList<Electronics>();
            ...
            for(String key : rb.keySet()) {
            	...
            	Electronics elec =  new Electronics(Integer.parseInt(data[0]), data[1], Integer.parseInt( data[2]), data[3]);
...
///////////////////////////////////////////////
	...
	public void saveObject() throws Exception {
		try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("src/electronics.txt"))) {
