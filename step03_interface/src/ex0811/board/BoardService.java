...
public interface BoardService {
	 ...
	 * @param: Board
	 * 
	 * @return: boolean (true이면 수정 완료, false이면 수정 실패)
	 * 
	 */
	 ...
	 * @param: int no
	 * 
	 * @return: Board (글번호에 해당하는 게시물이 있으면 Board, 리턴 없으면 Null 리턴)
	 * 
	 */
	 ...
	 *    body 있는 메소드를 만들 수 있다.
	 *    body가 있는 메소드는 구현 객체들이 재정의 선택적으로 할수 있다.
	 *
	 *    1) static
	 *         : 구현 객체없이 바로 interface 이름. 메소드이름() 호출
	 *
	 *    2) default
