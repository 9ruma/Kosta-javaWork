...
class UsingMethodExam{
	...
	*/	
	...
	void methodExam03_03(int i, String str) {
		System.out.println("methodExam03_03가 호출되었습니다.");
		methodExam03_02(str, i);
	}
	...
	*/	
	...
	protected double methodExam03_04(int i, double d, int j) {
		...
		double result = me.methodExam02_04(i, d, j);
...
class UsingMethod{
	public static void main(String[] args) {	
		...
		System.out.println(ume.methodExam03_02("준혁", 10));
		ume.methodExam03_03(15, "멋쟁이");
		System.out.println(ume.methodExam03_04(20, 5.5, 25));
