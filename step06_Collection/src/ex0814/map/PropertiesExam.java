...
public class PropertiesExam {
	...
	public PropertiesExam() {
		// 저장
		pro.setProperty("id", "Cha");
		pro.setProperty("age", "20");
		pro.setProperty("name", "Joonhyeok");
    ...
    public void test01() throws Exception {
    	...
    	// load는 a.properties의 key와 value를 Map 형태로 만들어줌
    	...
    	//this.getClass().getClassLoader().getResourceAsStream("ex0220/map/a.properties");
